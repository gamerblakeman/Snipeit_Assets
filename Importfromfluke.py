...
output = "Asset Tag,Model Name,Next Audit Date,PatTest_Result,Location\n"
for a in Appliances:
    nextdate = datetime.datetime.strptime(Appliances[a]['date'], "%d-%b-%y") + datetime.timedelta(days=365)
    output += f"{a},{Appliances[a]['itemtype']},{nextdate},{Appliances[a]['OverallResult']},{Appliances[a]['location']}\n"

with open("output.csv", "w") as f:
    f.write(output)


#{'earthbond': ['testcurrent', 'resistance', 'pass', 'limit'], 
# 'ins1': ['testvoltage'], 
# 'load': ['load', 'pass', 'limit', 'pncontinuity'], 
# 'current': ['current', 'pass', 'limit'], 
# 'leakage': ['current', 'pass', 'limit'], 
# 'iectest': ['continuity', 'earth', 'earthpass', 'earthlimit'], 
# 'ins2': ['testvoltage'], 
# 'subst2': ['current', 'pass', 'limit'], 
# 'touch': ['current', 'pass', 'limit', 'pncontinuity']}
#['testcurrent', 'resistance', 'pass', 'limit', 'testvoltage', 'load', 'pncontinuity', 'current', 'continuity', 'earth', 'earthpass', 'earthlimit']
#['earthbond', 'ins1', 'load', 'current', 'leakage', 'iectest', 'ins2', 'subst2', 'touch']
#VISUAL - Limit: - - Measurement: [OK] - Result: Passed
#RPE - Limit: ≤ 0.3 - Measurement: [0.06 OHM] - Result: Passed
#RINS - Limit: ≥ 1.0 - Measurement: [72.1 MOHM] - Result: Passed
#L,N-condition - No Data
#IPE - Limit: ≤ 3.5 - Measurement: [0.05 mA] - Result: Passed
#FUNCTION - Limit: ≤ 3000 - Measurement: [1095 VA] - Result: Passed
#IB - No Data
#IEA - No Data
...
#{'tests': 
# {'earthbond': {'testcurrent': '25A', 'resistance': '0.04 OHM', 'pass': 'P', 'limit': '0.30 OHM'}, --
# 'ins1': {'testvoltage': '1   >299 MEG P'}, --
# 'load': {'load': '1035 VA', 'pass': 'P', 'limit': '3000 VA', 'pncontinuity': 'P'}, --
# 'current': {'current': '4.4 A', 'pass': 'P', 'limit': '13.0 A'}, --
# 'leakage': {'current': '0.05 mA', 'pass': 'P', 'limit': '3.50 mA'}}, --
# 'testnum': '2', ---
# 'date': '11-AUG-25', ----
# 'appno': '00277', -----
# 'testmode': '100 AUTO', -----
